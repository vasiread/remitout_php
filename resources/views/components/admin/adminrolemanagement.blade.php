        ...
        `;
            ...
            document.querySelectorAll('.role-management-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    const index = Array.from(document.querySelectorAll('.role-management-row')).indexOf(
                    row);
  ...
  fetch('/api/admins', {
    ...
    .then(data => {
      if (data.success) {
        ...
        // ❌ Remove invalid unsaved entry from admins[]
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            dropdownItems.forEach(item => {
                item.addEventListener('click', () => {
                    ...
                    else if (val === 'email-new') sorted.sort((a, b) => new Date(b.created_at) -
                        new Date(a.created_at));
                    else if (val === 'email-old') sorted.sort((a, b) => new Date(a.created_at) -

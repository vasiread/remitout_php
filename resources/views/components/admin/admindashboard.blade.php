...
<body>
    ...
    <div class="admindashboard-container">
                        ...
                        <div class="donutgraphinfos">
                            ...
                            <div class="graphviewofregistrations">
                                <div class="graphviewofregistrations-firstpart">
                                    <div class="points"
                                        style="background-color: {{ htmlspecialchars($source['color'], ENT_QUOTES, 'UTF-8') }}; width: 11px; height: 11px;">
                                    </div>
        ...
        <script>
                ...
                try {
                    ...
                    const downloadPDF = () => {
                        ...
                        try {
                            ...
                            // Title on right
                            doc.text('November', doc.internal.pageSize.getWidth() - 53, 115, {
                                align: 'right'
                            });
                            ...
                            doc.autoTable({
                                ...
                                head: [
                                    ['Date', 'Name', 'Type', 'Source', 'Point of entry']
                                ],
                                body: [
                            ...
                            doc.autoTable({
                                ...
                                head: [
                                    ['City', 'State', 'Female', 'Male', 'other', 'No. students']
                                ],
                                body: [
                            ...
                            doc.autoTable({
                                ...
                                head: [
                                    ['Country', 'Continent', 'Female', 'Male', 'other', 'No. students']
                                ],
                                body: [
                            ...
                            doc.autoTable({
                                ...
                                head: [
                                    ['NBFC Name', 'Student Name', 'Unique ID', 'Type', 'Proposal status', 'Start Date', 'Time taken']
                                ],
                                body: [
                            ...
                            if (doc.autoTable.previous.finalY > 200) {
                                ...
                                doc.autoTable({
                                    ...
                                    head: [
                                        ['Referral code', 'Student Name', 'Unique ID', 'Type', 'Proxy Application', 'Date']
                                    ],
                                    body: [
            ...
            // Function to generate and update the legend dynamically
            const generatePointEntryLegend = (labels, colors) => {
                const legendContainer = document.querySelector('.point-entry-legend-container');
                if (!legendContainer) {
                ...
                const maxItemsPerColumn = Math.ceil(labels.length / 2);
                const legendColumns = [document.createElement('div'), document.createElement('div')];
                legendColumns.forEach(col => {
                    col.className = 'point-entry-legend';
                ...
                labels.forEach((label, index) => {
                    ...
                    legendColumns[columnIndex].appendChild(legendItem);
                });
            };

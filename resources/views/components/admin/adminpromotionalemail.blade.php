...
<body>
        ...
        <div class="promotional-composer-main-section">
            ...
            <div class="promotional-composer-container">
                ...
                <div class="promotional-content-area" contenteditable="true">
                    ...
                    <p class="promotional-sub">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                ...
                <div class="promotional-recipients-section">
                    ...
                    <table class="promotional-recipients-table">
                        ...
                        <tbody id="recipientTableBody">
                            <!-- Recipient rows will be dynamically populated -->
                        </tbody>
                    </table>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const recipients = [
                { name: "Mechupatti korukular teddy", id: "HLMLHU765857", email: "korukular2017@gmail.com", mobile: "8375635778" },
                { name: "John Doe", id: "HLMLHU765858", email: "john.doe@gmail.com", mobile: "9123456789" },
